...
5. Добавь конкретную выгоду или кейс из списка выше
6. Закончи вопросом или призывом к действию
7. Пиши на русском языке

Примеры хороших сообщений:
- "Привет! Видел ваш ресторан на картах — отличные отзывы 🔥 Хотел предложить попробовать Delever — 1000+ ресторанов уже используют для онлайн-заказов. Интересно было бы глянуть?"
- "Привет! Мы помогаем ресторанам принимать заказы онлайн без комиссий агрегаторов. MAXWAY например увеличили выручку, убрав Glovo комиссию. Можем обсудить?"`;
...
📦 О ПРОДУКТЕ (используй для контекста, НЕ для прямой продажи в первом касании):
...
- "Дорого" → Покажи ROI: экономия 5-15 млн сум/мес на комиссиях агрегаторов
- "Нет времени" → Запуск за 1 день, мы берём всю техническую работу
- "Уже есть решение" → Уточни какое. У нас ${PRODUCT_KNOWLEDGE.stats.integrations} интеграций, возможно дополним
- "Не нужно" → Уточни почему. Может есть проблема с доставкой/заказами которую не озвучили?

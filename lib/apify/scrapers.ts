...
export const SCRAPERS: ScraperConfig[] = [
  ...
  },
  {
    id: 'yandex-maps',
    name: 'Яндекс.Карты',
    description: 'Парсинг заведений из Яндекс.Карт (через Web Scraper)',
    icon: '🔴',
    actorId: 'apify/web-scraper',
    costPerItem: 0.003,
    avgTimePerItem: 3,
    fields: [
      { key: 'name', label: 'Название', type: 'string', description: 'Название заведения', example: 'Кафе Пушкин', mapTo: 'name' },
      { key: 'address', label: 'Адрес', type: 'string', description: 'Адрес', example: 'ул. Тверская, 1', mapTo: 'address' },
      { key: 'rating', label: 'Рейтинг', type: 'number', description: 'Рейтинг', example: 4.8, mapTo: 'rating' },
      { key: 'reviewsCount', label: 'Отзывы', type: 'number', description: 'Кол-во отзывов', example: 500, mapTo: 'ratingCount' },
      { key: 'phone', label: 'Телефон', type: 'string', description: 'Телефон', example: '+7 495 999-99-99', mapTo: 'phone' },
      { key: 'url', label: 'Ссылка', type: 'string', description: 'URL на Яндекс.Картах', example: 'https://yandex.ru/maps/org/...', mapTo: 'sourceUrl' },
    ],
    defaultInput: {},
    inputFields: [
      { key: 'searchQuery', label: 'Что искать', type: 'text', placeholder: 'рестораны', default: 'рестораны' },
  ...
  },
  {
    ...
    avgTimePerItem: 3,
    fields: [
      { key: 'name', label: 'Название', type: 'string', description: 'Название', example: 'Ресторан', mapTo: 'name' },
      { key: 'address', label: 'Адрес', type: 'string', description: 'Адрес', example: 'ул. Ленина, 1', mapTo: 'address' },
      { key: 'rating', label: 'Рейтинг', type: 'number', description: 'Рейтинг', example: 4.5, mapTo: 'rating' },
      { key: 'phone', label: 'Телефон', type: 'string', description: 'Телефон', example: '+7 999 123-45-67', mapTo: 'phone' },
    ],
    defaultInput: {},
    inputFields: [
      { key: 'searchQuery', label: 'Что искать', type: 'text', placeholder: 'рестораны', default: 'рестораны' },
      { key: 'city', label: 'Город', type: 'text', placeholder: 'moscow', default: 'moscow' },
      { key: 'maxResults', label: 'Количество', type: 'number', default: 50 },
    ],
  },
];

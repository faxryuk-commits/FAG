      ...
      <div className="h-44 relative overflow-hidden">
        {restaurant.images?.[0] ? (
          <Image
            ...
            priority={priority}
            placeholder="blur"
            blurDataURL="data:image/jpeg;base64,"
          />
        ) : (
